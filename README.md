...
Given the extensive and ambitious nature of this project, I have made extensive use of moder tools for producing implementation. Namely, I have made extensive use of Claude-4 Sonnet [1] to aid me with the following:
